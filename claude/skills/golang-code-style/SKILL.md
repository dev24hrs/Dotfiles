...
Many rules are enforced automatically:  `gofumpt`, `goimports`, `gocritic`, `revive`, `wsl_v5`. → See the `golang-lint` skill.
...
- → See the `golang-continuous-integration` skill for automated AI-driven code review in CI using these guidelines
