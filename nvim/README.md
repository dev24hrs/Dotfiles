...
| JavaScript/TypeScript | tsgo          | oxfmt               | oxlint        |
| YAML                  | yamlls        | yamlfmt             | yamllint      |
| JSON                  | jsonls        | oxfmt               | jsonlint      |
| Bash                  | bashls        | shfmt               | shellcheck    |
| Fish                  | fish-lsp      | fish_indent         | fish          |
| SQL                   | sqls          | sqlfmt              | sqlfluff      |
| Markdown              | marksman      | oxfmt               | markdownlint  |
...
- [tabline](https://github.com/dev24hrs/Dotfiles/blob/main/nvim/lua/config/tabline.lua) Neovim's built-in tabline with customizable style & behavior
- [statusline](https://github.com/dev24hrs/Dotfiles/blob/main/nvim/lua/config/statusline.lua) Neovim's built-in statusline showing mode, Git info, indent style,
  and more
...
- [Friendly snippets](https://github.com/rafamadriz/friendly-snippets) `blink.cmp` built-in & customize personal snippets
